 ...
 */
class UserFrontRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
    ...
    public function save(UserFront $entity, bool $flush = false): void
    {
    ...
    public function remove(UserFront $entity, bool $flush = false): void
    {
...
//    /**
//     * @return UserFront[] Returns an array of UserFront objects
//     */
...
//    public function findOneBySomeField($value): ?UserFront
//    {
//        return $this->createQueryBuilder('u')
//            ->andWhere('u.exampleField = :val')
//            ->setParameter('val', $value)
